...
public class frame2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please enter your Name, Oreder ID and the Number of cakes you want to order.");
        ...
        jLabel5.setText("*Number of Cakes:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        oID = jTextField2.getText();
        NoC = jTextField3.getText();
        int nOc = 0;
        try{
         nOc = Integer.parseInt(NoC); 
         }catch(NumberFormatException ex ){
            JOptionPane.showMessageDialog(this, "invalid format of the Number , try again");
           jTextField3.setText("");
           return ; 
        }
       ObjOrder = new Order(name, oID, nOc);
       JOptionPane.showMessageDialog(this, "The order has been successfully made!");

    

        frame3 addframe = new frame3();
